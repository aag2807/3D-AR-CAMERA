...
const superThat:any = (function(){
    ...
    let _threeFiberCompositeObjects:any = null, _threeProjMatrix:any = null;
    const _previousSizing = {
      width: 1, height: -1
    };
  
    let _threeTranslation:any = null,
        _maxFaces:number = -1,
        _detectCallback:any = null,
        _videoElement:any = null,
        _scaleW:any = 1,
        _canvasAspectRatio:number = -1;
    
    function detect(detectState: { [x: string]: any; }){
      _threeFiberCompositeObjects.forEach(function(threeFiberCompositeObject: any, i: string | number){
    ...
    function update_poses(ds: { [x: string]: any; }, threeCamera: { aspect: number; fov: number; }){
    ...
    // public methods:
    const that = {
      init: function(spec: { maxFacesDetected: number; videoElement: null; }, threeObjects: null, detectCallback: null){
      ...
      update: function(detectStates: any, threeCamera: any){
      ...
      create_occluder: function(occluderGeometry: any){
      ...
      update_camera: function(sizing: { width: number; height: number; }, threeCamera: { matrixAutoUpdate: boolean; position: { set: (arg0: number, arg1: number, arg2: number) => void; }; updateMatrix: () => void; fov: number; view: { offsetX: number; offsetY: number; } | null; projectionMatrix: { equals: (arg0: null) => any; }; aspect: number; setViewOffset: (arg0: number, arg1: number, arg2: number, arg3: number, arg4: any, arg5: any) => void; updateProjectionMatrix: () => void; }){
